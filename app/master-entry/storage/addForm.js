import { addStorage } from '@/lib/apiCalls/storage';
...
export default function AddForm() {
    ...
    const handleSubmit = (e) => {
        ...
        const isRefrigerated = e.target.isRefrigerated.checked;
        const data = { name, isRefrigerated, description };
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <label className='flex gap-2 items-center justify-start cursor-pointer'>
                                <input type="checkbox" id='isRefrigerated' className="checkbox checkbox-info" />
                                Is Refrigerated
                            </label>
                        </div>
                        <div className="divider" />
