import { addUnit } from '@/lib/apiCalls/unit';
...
export default function AddForm() {
    ...
    const handleSubmit = (e) => {
        ...
        const data = { name, abbreviation, description };
                ...
                <div className="modal-box">
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" required id="abbreviation" placeholder="Abbreviation" className="input w-full" />
